...
insert into test values('컴퓨터활용능력2급','2019-03-03','2019-03-03','필기',104);
insert into test values('컴퓨터활용능력2급','2019-04-13','2019-04-13','필기',104);
insert into test values('컴퓨터활용능력2급','2019-04-27','2019-04-27','필기',104);
insert into test values('컴퓨터활용능력2급','2019-06-29','2019-06-29','필기',104);
insert into test values('컴퓨터활용능력2급','2019-11-15','2019-11-15','필기',104);
insert into test values('컴퓨터활용능력2급','2019-10-12','2019-10-12','필기',104);
commit;
...
-- [회원 보유기술] -- 
insert into member_skill values('kim@naver.com', 'java');
insert into member_skill values('choi@naver.com','c');
insert into member_skill values('hwang@naver.com','c++');
insert into member_skill values('jung@gmail.com','python');
commit;
...
-- [회원별-추천공고] --
insert into member_recom_offer values(101,'kim@naver.com','기술');
insert into member_recom_offer values(102,'choi@naver.com','기술');
insert into member_recom_offer values(103,'hwang@naver.com','직무');
insert into member_recom_offer values(104,'jung@gmail.com','직무');
commit;

-- [회원별-자격시험일정] --
insert into member_test values('kim@naver.com', '정보처리기사', '2019/04/13', '2019/04/13');
insert into member_test values('choi@naver.com', '정보처리기사', '2019/04/27', '2019/04/27');
insert into member_test values('choi@naver.com', '정보처리기사', '2019/06/29', '2019/06/29');
insert into member_test values('choi@naver.com', '정보처리기사', '2019/11/15', '2019/11/15');
insert into member_test values('hwang@naver.com', '정보처리기사', '2019/06/29', '2019/06/29');
insert into member_test values('jung@gmail.com', '정보처리기사', '2019/11/15', '2019/11/15');
commit;

-- [채용공고-요구사항] --
insert into offer_specs values(101,'frontend','java',1);
insert into offer_specs values(101,'frontend','python',2);
insert into offer_specs values(101,'backend','c',1);
insert into offer_specs values(102,'backend','java',1);
commit;
